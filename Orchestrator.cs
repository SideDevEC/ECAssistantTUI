...
/// <summary>Parses a single <toolcall> block content to extract tool name and arguments.</summary>
    ...
    private string BuildStepDirective()
    {
        ...
        sb.AppendLine("ALWAYS wrap in <llm>...</llm>. Use <thinking>brief reasoning</thinking> followed by either <output>your answer</output> (if done) or another <toolcall> (if you need more data).");
